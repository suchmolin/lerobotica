...
export default function CardDif({ data }) {
  ...
  return (
    <div className="w-[290px] xs:w-[360px] sm:w-[530px] lg:w-[320px] xl:w-[390px] xxl:w-[400px] hover:bg-violetaLR hover:scale-[102%] bg-azulClaroLR rounded-t-2xl overflow-hidden flex flex-col text-white p-7 transition-all duration-300">
